...
**Nota:** Esta es una traducción al español de la licencia MIT únicamente con fines de referencia.
La versión oficial y legalmente vinculante es la redactada en inglés en el archivo `LICENSE`.
...
publicar, distribuir, sublicenciar y/o vender copias del Software, y para permitir a las personas
a quienes se les proporcione el Software a hacer lo mismo, sujeto a las siguientes condiciones:
...
OTRO MODO, QUE SURJA DE O EN CONEXIÓN CON EL SOFTWARE O EL USO U OTROS
